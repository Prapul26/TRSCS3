...
<div>
    <lable>Title</lable><span style={{color:"red"}}>*</span><br/>
    <input value={title} onChange={(e)=>setTitle(e.target.value)}/>
</div>
<div>
    <lable>Category</lable><span style={{color:"red"}}>*</span><br/>
...
<div>
    <lable>Email body</lable><span style={{color:"red"}}>*</span><br/>
    <textarea  value={description} onChange={(e)=>setDescription(e.target.value)}/>
</div>
<div className='saveTempButton'><button type='submit'>SAVE</button></div>
{message && <div className="message">{message}</div>}
</form>
      </div>
     <div style={{marginLeft:"20px"}}><button onClick={handleClick}>Template Token</button></div>
    </div></div></div></div>
    <div>
      { templateTokens && <div className='templateTokensContainer'>
        <div className='templateTokenHolder'>
            <div className='tokenXross'>
                <div style={{marginBottom:"15px",marginTop:"10px"}}>Template Tokens</div>
                <div style={{marginBottom:"15px",marginTop:"10px",fontWeight:"700",cursor:'pointer'}} onClick={cancleX}>X</div>
            </div>
            <div className='tokenP'>
               
                    <div>
                <div><h2>Tokens for Members</h2>
                    </div>
