...
<Link to="/contactUs" style={{ color: "inherit", textDecoration: "none" }} >          <div className={`rdsewdx ${currentPath === "/contactUs"  ? "active" : ""}`}> <div style={{ marginLeft: "14px",marginTop:"9px" }}><FaRegComment  size={20} />
                ...
                <Link to="/networking" style={{ color: "inherit", textDecoration: "none" }} >          <div className={`rdsewdx ${currentPath === "/networking"  ? "active" : ""}`}> <div style={{ marginLeft: "14px",marginTop:"9px" }}><LuChartNetwork  size={20} />
