        ...
        <div className='intro9'>
          ...
          </div>
          {
            settings && <div style={{ marginLeft: "15px" }}>
              ...
              <Link to='/passwordChange' style={{ color: "inherit", textDecoration: "none" }} className={`menu-item ${currentPath === "/passwordChange" ? "active" : ""}`}> <div style={{ display: "flex" }} className={`uk1 ${currentPath === "/passwordChange" ? "active" : ""}`}> <div style={{ paddingLeft: "15px" }}>< RiLockPasswordFill /></div><ul style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: "600", fontSize: "16px", marginTop: "0px", marginLeft: "-20px" }}>Change Password</ul></div></Link>
        ...
        <div className="intro1">
          <div className={`inDiv ${(
            ...
            intro && <div className="intoNav" style={{ marginLeft: "7px" }}>
              ...
              <Link to='/signature' style={{ color: "inherit", textDecoration: "none" }} className={`menu-item ${currentPath === "/signature" ? "active" : ""}`}> <div style={{ display: "flex" }} className={`uk1 ${currentPath === "/signature" ? "active" : ""}`}><div style={{ paddingLeft: "15px" }}><FaFileSignature /></div><ul style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: "600", fontSize: "16px", marginTop: "0px", marginLeft: "-20px" }}>Signature</ul></div></Link>
