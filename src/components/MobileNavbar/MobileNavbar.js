      ...
      {mobnav && (
        <div className={`mobMenu ${mobnav ? "open" : ""}`}>
          ...
          <div className="introduction41" onClick={handelIntro2}>
            <div style={{display:"flex"}}><div style={{marginTop:"13px",marginRight:"12px"}}><IoSettingsSharp size={20} color="white"/> </div>
          ...
          <div style={{marginTop:"14px"}}><IoArrowDownCircle color="white" size={20}/></div>
            </div>
                {
                                                intro2 && <div className="intoNav" style={{marginLeft:"7px"}}>
                                                  <Link to='/myMembership' style={{color:"inherit",textDecoration:"none"}}><div style={{display:"flex" ,marginBottom:"8px"}}><div>< MdOutlineCardMembership size={20}color="white" style={{marginRight:'7px',marginTop:'4px'}} /></div><h3 style={{color:"white",fontSize:'large'}}>My Membership</h3></div></Link>
                                                 <Link to='/accountSettings'  style={{color:"inherit",textDecoration:"none"}}><div style={{display:"flex",marginBottom:"8px"}}><div><IoPerson  size={20}color="white" style={{marginRight:'7px',marginTop:'4px'}} /></div><h3 style={{color:"white",fontSize:'large'}}>My Profile</h3></div></Link> 
                                                 <Link to='/passwordChange'style={{color:"inherit",textDecoration:"none"}} ><div style={{display:"flex",marginBottom:"8px"}}> <div><IoPerson size={20} color="white" style={{marginRight:'7px',marginTop:'4px'}} /></div><h3 style={{color:"white",fontSize:'large'}}>My Password</h3></div></Link> 
                                                 <Link to='/affiliation'style={{color:"inherit",textDecoration:"none"}} > <div style={{display:"flex",marginBottom:"8px"}}><div><TbArrowsRandom  size={20}color="white" style={{marginRight:'7px',marginTop:'4px'}} /></div><h3 style={{color:"white",fontSize:'large'}}>Affiliation</h3></div></Link> 
          ...
          <div style={{marginTop:"-9px"}}> <h2>Logout</h2></div>
          </div>
          <div></div>
        </div>
      )}
